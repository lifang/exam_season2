...
class PhrasesController < ApplicationController
  ...
  def index
    @words = Word.show_words(params[:category].to_i, nil, nil, params[:page])
  end
  ...
  def search
    ...
    redirect_to "/phrases/search_list?category=#{params[:category]}"
  end

  def search_list
    @words = Word.show_words(params[:category].to_i, session[:word_level], session[:word_text], params[:page])
    render "index"
  end
  ...
  def create
    ...
    redirect_to "/phrases?category=#{params[:category_id]}"
  end
  ...
  def list_similar
    ...
    render :partial => "/phrases/similar_list"
  end
  ...
  def update
    ...
    flash[:notice] = "编辑成功"
    redirect_to "/phrases/search_list?category=#{params[:category_id]}&page=#{params[:page]}"
  end
