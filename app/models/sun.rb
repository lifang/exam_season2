...
class Sun < ActiveRecord::Base
  ...
  TYPES = {:FIRSTLOGIN => 0, :TEST => 1, :SIGNIN => 2, :SINASHARE => 3,:RENRENSHARE => 4 ,:KEEP_ON_LOGIN =>5,
    ...
    :OPEN_KAOYAN=>13,:CHARGE=>14,:SKILL=>15} #0首次登陆 1前测 2签到 3新浪微博分享 4人人分享 5连续登录 6 随机奖励 7 推荐 8答疑,14 充值
  TYPE_NUM = {:FIRSTLOGIN => 1, :GRADUATE_TEST => 14, :CET_TEST => 4, :SIGNIN => 1, :SHARE => 2,
    :KEEP_ON_LOGIN => 1, :RANDOM_AWARD => 2, :COMMEND => 5, :ANSWER => 2,:LOGIN_MORE=>5,:CET=>-3,:KAOYAN=>-8,:SKILL=>2}
